...
- (id)initWithCoder:(NSCoder *)coder {
    ...
    if (self) {
        self.opcionesSopaArr = [NSArray arrayWithObjects:@"De verduras", 
                                @"De guineo",
                                @"De fríjoles",
                                nil];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
	cell.textLabel.text = [self.opcionesSopaArr objectAtIndex:[indexPath row]];
